...
const handler: NextApiHandler = async (req, res) => {
    ...
    await dbConnect();
    if (req.method === "POST") {
        const data = await hostings.findOneAndUpdate({user: req.body.user}, {$set:{firstMenu : req.body.firstMenu, secondMenu : req.body.secondMenu, thirdMenu: req.body.thirdMenu}}) as Hostings;
