...
function AmenitiesSecondCard(props: Props) {
    ...
    const partButton = () => {
        if (buttonCheck === false) {
            props.setSecondMenu([...props.secondMenu, props.data.text]);
            setBorderColor("black");
            setBorderCheck(true);
            setBorder(3);
            setButtonCheck(true);
        } else {
            for(var i = 0; i < props.secondMenu.length; i++){ 
                if (props.secondMenu[i] === props.data.text) { 
                    props.secondMenu.splice(i, 1); 
                  i--; 
                }
            }
            ...
            props.setSecondMenu(props.secondMenu);
        }
    };
...
export default AmenitiesSecondCard;